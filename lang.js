...
document.getElementById("lang").addEventListener("change", (e) => {
  ...
  document.getElementById("labelState").innerText = t.labelState;
  document.getElementById("labelPH").innerText = t.labelPH;
  document.getElementById("labelNitrogen").innerText = t.labelNitrogen;
  document.getElementById("labelPhosphorus").innerText = t.labelPhosphorus;
  document.getElementById("labelPotassium").innerText = t.labelPotassium;
  document.getElementById("labelOrganic").innerText = t.labelOrganic;
  document.getElementById("labelTexture").innerText = t.labelTexture;
  ...
  t.states.forEach((name, index) => {
    ...
    option.value = originalValues[index]; // keep the value in English for backend use
